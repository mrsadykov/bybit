...
return [
    ...
    'confirm_delete' => 'Удалить этого бота?',
    ...
    // Риск-лимиты (приоритет 2)
    'max_daily_loss_usdt' => 'Макс. дневной убыток (USDT)',
    'max_daily_loss_placeholder' => 'Пусто = без лимита',
    'max_daily_loss_help' => 'При достижении убытка за день торговля по боту приостанавливается до следующего дня.',
    ...
    'max_losing_streak_placeholder' => 'Пусто = не учитывать',
    'max_losing_streak_help' => 'При N убыточных сделках подряд бот пропускается до сброса базиса или следующего дня.',
    'reset_risk_baseline' => 'Сбросить базис риска',
    'reset_risk_baseline_short' => 'Сброс риска',
    'reset_risk_baseline_confirm' => 'Сбросить базис просадки и серии убытков? Учитываться будут только сделки после этого момента.',
    'risk_baseline_reset' => 'Базис просадки и серии убытков сброшен. Учитываются только сделки после текущего момента.',
    'risk_drawdown_reset_at' => 'Базис риска сброшен',
