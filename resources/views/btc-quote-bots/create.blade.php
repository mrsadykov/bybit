                    ...
                    <form action="{{ route('btc-quote-bots.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                <input type="number" name="max_daily_loss_btc" id="max_daily_loss_btc" value="{{ old('max_daily_loss_btc') }}" step="0.00001" min="0" placeholder="—"
                                    class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                            ...
                            <div>
                                ...
                                <input type="number" name="max_losing_streak" id="max_losing_streak" value="{{ old('max_losing_streak') }}" step="1" min="1" max="20" placeholder="—"
                                    class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
